...
#
# multiple_UI = uic.loadUiType('multiple_UI.ui')[0]
#
# class multipleClass(QMainWindow, multiple_UI):
#
#     def __init__(self):
#         super().__init__()
#         self.setupUi(self)
...
#         self.encrypt.clicked.connect(self.encryptionFunction)
#
#         self.decrypt = QPushButton('복호문', self)
#         self.decrypt.toggle()
#         self.decrypt.resize(80, 25)
#         self.decrypt.move(420, 260)
#         self.dncrypt.clicked.connect(self.DecryptionFunction)
#
...
#
#     # 암호문 눌렀을 때
#     # def encryptionFunction(self):
#     #     return
#     #
#     # def DecryptionFunction(self):
#     #     return
#
#     def center(self):
